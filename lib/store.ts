  ...
  persist(
    (set, get) => ({
      ...
      getIngredientsByCategory: (category) => {
        ...
        if (category === "todos") return ingredients
      ...
      addUserComment: (commentId: string, content: string, rating: number) => {
        // Implementação para adicionar comentário do usuário
        set((state) => {
      ...
      updateUserComment: (commentId: string, content: string, rating: number) => {
        // Implementação para atualizar comentário do usuário
        set((state) => {
          const userComments = state.userComments || []
      ...
      deleteUserComment: (commentId: string) => {
        // Implementação para excluir comentário do usuário
        set((state) => {
          const userComments = state.userComments || []
          return {
            ...state,
